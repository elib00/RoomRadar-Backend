...
namespace RoomRadar_Backend.Migrations
{
    ...
    [Migration("20241208122351_AddedPendingLandlord")]
    partial class AddedPendingLandlord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoomRadar_Backend.Models.LandLordCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RoomRadar_Backend.Models.LandLordCredential", b =>
                {
                    b.HasOne("RoomRadar_Backend.Models.UserProfile", "UserProfile")
                        .WithOne("LandLordCredential")
                        .HasForeignKey("RoomRadar_Backend.Models.LandLordCredential", "UserProfileId")
            ...
            modelBuilder.Entity("RoomRadar_Backend.Models.UserProfile", b =>
                {
                    b.Navigation("LandLordCredential");
                });
